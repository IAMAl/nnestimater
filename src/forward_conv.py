...
def forward_conv(args, f_out, config_hard, config_prev_layer, config_pres_layer, dim, input_length_): 
    ...
    total_number_of_multiplies  = number_of_parallel_kernels * output_size * window_size * (1 - zero_ratio_op)
    total_number_of_additions   = number_of_parallel_kernels * ((output_size * window_size - 1 + 1) + (number_of_parallel_kernels - 1) * output_size) * (1 - zero_ratio_op)
    total_number_of_divisions   = 0
    total_number_of_activations = number_of_parallel_kernels * output_size
